...
INT ReflectionNormalShaderProperties::InitProperties(ID3D11DeviceContext* _p_d3ddevicecontext, ID3D11Device* _p_d3ddevice, XMFLOAT4X4* _worldmatrix)
{
...
void ReflectionNormalShaderProperties::DeinitProperties()
{
...
void ReflectionNormalShaderProperties::Update()
{
	//Update Matrices
...
void ReflectionNormalShaderProperties::UpdateMatricesBuffer()
{
	//Set Matrices
