...
class ReflectionNormalShaderProperties : public MaterialProperties
{
public:
	ReflectionNormalShaderProperties(LPCTSTR _texturename, LPCTSTR _normaltexturename, LPCTSTR _reflecttexturename, FLOAT _glossy, XMFLOAT4 _specularcolor, FLOAT _specularpower)
	{
		//Set Properties
		glossy = _glossy;
		specularPower = _specularpower;
		specularColor = _specularcolor;
		materialType = EMaterials::ReflectionNormalShader;
